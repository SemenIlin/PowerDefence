...
public class Enemy : GameBehaviour
{
    ...
    public void Initialize(float scale, float pathOffSet, float spead, float health)
    {
    ...
    private void PrepareTurnRight()
    {
        ...
        _progressFactor = _spead / (Mathf.PI * 0.5f * (0.5f - _pathOffSet));
    }
    ...
    private void PrepareTurnAround()
    {
        ...
        _progressFactor = _spead / (Mathf.PI * Mathf.Max(Mathf.Abs(_pathOffSet), 0.2f));
    }
